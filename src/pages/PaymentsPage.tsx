...
const benefits = [
  {
    icon: Percent,
    title: "Экономия от 3 до 7%",
    description: "Подключение напрямую обходится дешевле, чем через платёжный модуль GetCourse",
  },
  {
    icon: Receipt,
    title: "Автоматические чеки ОФД",
    description: "Настроим автоматическую выдачу чеков для всех платёжных систем",
  },
  {
    icon: CreditCard,
    title: "Комбинирование методов",
    description: "Оставьте GetPay для карт, а рассрочки подключим напрямую",
  },
];
